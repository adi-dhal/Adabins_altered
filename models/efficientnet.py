...
def get_act_layer(name="relu"):
    ...
    if name in _ACT_FN_JIT:  # jit scripted models should be okay for export/scripting
...
def load_pretrained(model, filter_fn=None, strict=True):
    state_dict = torch.load("./pretrained/tf_efficientnet_b5_ap-9e82fae8.pth")
...
def _gen_efficientnet(
    channel_multiplier=1.6, depth_multiplier=2.2, pretrained=True, **kwargs
):
    arch_def = [
...
def get_efficientnet():
    ...
    model = _gen_efficientnet(**kwargs)
    return model
